...
pub static LANGUAGES_LOCALE_MAP: Lazy<HashMap<&str, &str>> = Lazy::new(|| {
    HashMap::from([
        // Based on https://saimana.com/list-of-country-locale-code/
        ("ar", "Arabic"),
        ...
        ("hr_ME", "Croatian (Montenegro)"),
        ("bs_ME", "Bosnian (Montenegro)"),
